        ...
        <div  id="modalOne" class="modal">
          <div class="modal-content">
            ...
            @endif
               ...
               <div style="margin-left: 30px;">
                  <textarea name="details" rows="4" placeholder="Details"></textarea>
                </div>  
              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <article class="entry">
                  ...
                  <div class="entry-meta">
                    <ul>
                      <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="{{ url('homerent') }}/{{ $item->rent_id }}">{{ $item->uni_location }}</a></li>
                      <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="{{ url('homerent') }}/{{ $item->rent_id }}"><time datetime="2020-01-01">{{ $item->created_at }}</time></a></li>
                    </ul>
                  </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item search-form">
                <form action="{{ url('/homerent/muslim') }}" method="GET">
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="post-item clearfix">
                  ...
                  <h4><a href="{{ url('university/'.$datas->rent_id) }}">{{ $datas->location }}</a></h4>
