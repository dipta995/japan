...
<main id="main">
    ...
    <section  id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <a class="btn btn-outline-danger" href="{{ url('rent/agent') }}/{{ session('agentid') }}">My Tolet</a>
         @endif
         ...
         <div  id="modalOne" class="modal">
           <div class="modal-content">
             ...
             @endif
                ...
                <div style="margin-left: 30px;">
                   <textarea name="details" rows="4" placeholder="University Details"></textarea>
                 </div>  
              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <article class="entry">
                  ...
                  <h2 class="entry-title">
                    <a href="{{ url('homerent') }}/{{ $item->agent_id }}">{{ $item->company_name }}</a>
                  </h2>

                  <div class="entry-meta">
                    <ul>
                      <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="{{ url('homerent') }}/{{ $item->rent_id }}">{{ $item->address_office }}</a></li>
                      <li class="d-flex align-items-center"><i class="icofont-phone"></i> <a href="{{ url('homerent') }}/{{ $item->rent_id }}"><time >{{ $item->phone }}</time></a></li>
                    </ul>
                  </div>
                  ...
                  <div class="entry-content">
                    ...
                    <div class="read-more">
                      <a href="{{ url('rent/agent')}}/{{ $item->agent_id }}">See All Post</a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                ...
                @foreach ($agentpostlimit as $datas)
                      
                 
                <div class="post-item clearfix">
                  <img src="{{ url('images') }}/{{ $datas->image_one }}" alt="">
                  <h4><a href="{{ url('university') }}/{{ $datas->agent_id }}">{{ $datas->location }}</a></h4>
