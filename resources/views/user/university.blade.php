              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <article class="entry">
                  ...
                  <div class="entry-meta">
                    <ul>
                      <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="university/{{ $item->uni_id }}">{{ $item->uni_location }}</a></li>
                      <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="university/{{ $item->uni_id }}"><time datetime="2020-01-01">Jan 1, 2021</time></a></li>
                    </ul>
                  </div>
                  ...
                  <div class="entry-content">
                    ...
                    <div class="read-more">
                      <a href="{{ url('university/'.$item->uni_id) }}">Read More</a>
                    </div>
                  </div>
